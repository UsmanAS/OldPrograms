...
function render( ) {
	...
	transformation = scalem(.5, .75, .5, 0); //mat4( );
	vTransformation = gl.getUniformLocation(program, "vTransformation");
	gl.uniformMatrix4fv(vTransformation, false, flatten(transformation));
